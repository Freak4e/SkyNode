...
export function PlannerRail({ itinerary, plannedBudget, selectedFlight, travelers, hotels = [], routeSegments = [] }: PlannerRailProps) {
  return (
    <aside className="space-y-4 lg:sticky lg:top-28 lg:self-start">
      <BudgetPanel itinerary={itinerary} plannedBudget={plannedBudget} selectedFlight={selectedFlight} travelers={travelers} />
