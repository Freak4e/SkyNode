            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_360px] lg:items-end">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-base leading-relaxed text-slate-300">
                  SkyNode combines destination attractions, your pace and interests, and your configured AI provider for this sprint.
                </p>
              </div>
                ...
                <div className="grid min-h-[420px] place-items-center rounded-3xl border border-dashed border-slate-200 bg-slate-50 p-10 text-center">
                  <div>
                    ...
                    <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-500">
                      Pick the trip mood and generate the itinerary. Attractions come from Geoapify; the plan is generated by the configured AI provider.
                    </p>
                  </div>
                </div>
              )}
